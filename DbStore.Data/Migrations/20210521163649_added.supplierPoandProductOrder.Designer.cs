...
namespace DbStore.Data.Migrations
{
    ...
    [Migration("20210521163649_added.supplierPoandProductOrder")]
    partial class addedsupplierPoandProductOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbStore.Data.ProductOrder", b =>
                {
            ...
            modelBuilder.Entity("DbStore.Data.SupplierProductOrder", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DbStore.Data.SupplierProductOrder", b =>
                {
                    ...
                    b.HasOne("DbStore.Data.ProductOrder", "ProductOrder")
                        .WithMany()
                        .HasForeignKey("ProductOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DbStore.Data.Supplier", "Supplier")
                        .WithMany()
